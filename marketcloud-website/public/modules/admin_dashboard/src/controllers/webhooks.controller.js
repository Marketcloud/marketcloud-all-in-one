...
module.exports = function(app) {
	app.controller('WebhooksController', ['$scope', '$http', 'webhooks','application','$rootScope',
		function(scope, http, webhooks, application,$rootScope) {
			...
			$rootScope.$broadcast('$dashboardSectionChange',{section : "webhooks"});
			scope.newWebhook = {}
			...
			scope.events.splice(scope.events.indexOf("orders.delete")+1, 0, "payments.create");
